<template>
  <div :id="transitionId" class="transition-container" :style="`${containerPosition}`">
...
export default {
  ...
  computed: {
    activeScale() {
      const scale = 2 * this.component.intersectionRatio + this.transition.intersectionRatio
      return scale
    },
