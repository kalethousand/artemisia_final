<template>
  <div class="inquire-view-container">
    <div class="inquire-view-content">
      <ContentTransition :is-active="set1IsActive" container-id="inquiry-content-set-1" class="inquiry-content-set-1">
            ...
            <FormSectionContent>
              <template #row-1>
                <FormRow class="form-row" p-top p-btm>
                  <template #column-1>
                    <p :class="`${breakpoint}-input section-label`">Contact</p>
                ...
                <FormRow class="form-row" p-top p-btm>
                  <template #column-1>
                    <div>
                      ...
                      <v-btn-toggle v-model="inquiryForm.floralBudget.range" tile group dense mandatory>
              ...
              <template #row-8>
                <FormRow class="form-row" p-top p-btm>
                  <template #column-1>
                    <p :class="`${breakpoint}-input section-label`">Ceremony</p>
                    <v-divider class="section-divider"></v-divider>
                  </template>
                </FormRow>
              </template>
              <template #row-9>
                <FormRow class="form-row" one-fourths-size p-top p-btm>
                  <template #column-1>
                    <TextInput
              ...
              <template #row-10>
                <FormRow class="form-row" p-top p-btm>
                  ...
                  <template #column-3>
                    <TextInput
                      v-model="inquiryForm.ceremony.venueAddress.Code"
                      animate-label
                      label="Zip"
                      :breakpoint="breakpoint"
                    />
              ...
              <template #row-11>
                <FormRow class="form-row" p-top p-btm>
                  <template #column-1>
                    <p :class="`${breakpoint}-input section-label`">Reception:</p>
                    <v-divider class="section-divider"></v-divider>
                  </template>
                </FormRow>
              </template>
                ...
                <FormRow class="form-row" p-top p-btm>
                  <template #column-1>
                    <TextArea
                      ...
                      :breakpoint="breakpoint"
                    />
                    <!-- <v-text-field v-model="inquiryForm.additionalComments" label="Comments or Important Details " type="text" /> -->
                  </template>
                </FormRow>
              </template>
            </FormSectionContent>
            <div class="submit-container">
              <div :class="`result-container ${breakpoint}-input`">
      ...
      <ContentTransition :is-active="set2IsActive" container-id="inquiry-content-set-2" class="inquiry-content-set-2">
...
export default {
  ...
  data: () => ({
    isLoading: false,
    idArray: ["inquiry-content-set-1", "inquiry-content-set-2"],
    ...
    initObserver() {
      ...
      const handleIntersectionEvent = entries => {
        entries.forEach(entry => {
          if (entry.target.id === `inquiry-content-set-1`) {
          ...
          if (entry.target.id === `inquiry-content-set-2`) {
...
.inquire-view-container {
  height: 220vh;
  width: 100%;
  position: relative;
  z-index: 4;

  .inquire-view-content {
    position: sticky;
    top: 30vh;
    height: 160vh;
  }

  .inquire-content-set-1 {
    opacity: 1;
